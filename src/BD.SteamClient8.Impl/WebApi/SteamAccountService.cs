...
#pragma warning restore IL2026 // Members annotated with 'RequiresUnreferencedCodeAttribute' require dynamic access otherwise can break functionality when trimming application code
    ...
    public async Task<ApiRspImpl<CookieCollection?>> OpenIdLoginAsync(string openidparams, string nonce, CookieCollection cookie)
    {
        var container = new CookieContainer();
        container.Add(cookie);
        var isolated = new IsolatedCookieContainer(container);
        var sendArgs = new WebApiClientSendArgs(SteamApiUrls.OpenIdloginUrl)
        {
            Method = HttpMethod.Post,
        ...
        try
        {
            var result = await WaitAndRetryAsync().ExecuteAsync(async () =>
            {
                ...
                if (!string.IsNullOrEmpty(html))
                {
                    ...
                    return container.GetCookies(new Uri(SteamApiUrls.STEAM_COMMUNITY_URL));
                }
                return null;
            });
            return result;
    ...
    public async Task<ApiRspImpl> DoLoginV2Async(SteamLoginState loginState)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                var (result, response) = await WaitAndRetryAsync().ExecuteAsync(async () =>
                {
            ...
            if (tokens.TransferInfo?.Count > 0)
            {
                foreach (var transfer in tokens.TransferInfo)
                {
                    ...
                    await WaitAndRetryAsync().ExecuteAsync(async () =>
                    {
                        ...
                        rsp = (await client.SendAsync(req)).EnsureSuccessStatusCode();
    ...
    public async Task<ApiRspImpl<(bool IsSuccess, string? Message, HistoryParseResponse? History)>> GetAccountHistoryDetail(SteamLoginState loginState)
    {
        ...
        var isolated = new IsolatedCookieContainer(container);
        var sendArgs = new WebApiClientSendArgs(SteamApiUrls.SteamStoreAccountHistoryDetailUrl)
        {
            Method = HttpMethod.Get,
            JsonImplType = Serializable.JsonImplType.SystemTextJson,
            IsolatedCookie = isolated,
    ...
    public async Task<ApiRspImpl<bool>> GetWalletBalance(SteamLoginState loginState)
    {
        ...
        container.Add(loginState.Cookies);
        var isolated = new IsolatedCookieContainer(container);
        var sendArgs = new WebApiClientSendArgs(SteamApiUrls.SteamStoreAccountlUrl)
        {
            Method = HttpMethod.Get,
            JsonImplType = Serializable.JsonImplType.SystemTextJson,
            IsolatedCookie = isolated,
    ...
    async Task<(SteamResult Result, PurchaseResultDetail? Detail)?> RedeemWalletCodeCore(SteamLoginState loginState, string walletCode)
    {
        ...
        container.Add(loginState.Cookies!);
        var isolated = new IsolatedCookieContainer(container);
        var sendArgs = new WebApiClientSendArgs(SteamApiUrls.SteamStoreRedeemWalletCodelUrl)
        {
            Method = HttpMethod.Post,
            JsonImplType = Serializable.JsonImplType.SystemTextJson,
            IsolatedCookie = isolated,
    ...
    public async Task<ApiRspImpl<bool>> SetSteamAccountCountry(SteamLoginState loginState, string? currencyCode)
    {
        ...
        container.Add(loginState.Cookies!);
        var isolated = new IsolatedCookieContainer(container);
        var sendArgs = new WebApiClientSendArgs(SteamApiUrls.SteamStoreAccountSetCountryUrl)
        {
            Method = HttpMethod.Post,
            JsonImplType = Serializable.JsonImplType.SystemTextJson,
            IsolatedCookie = isolated,
    ...
    public async Task<ApiRspImpl<List<CurrencyData>?>> GetSteamAccountCountryCodes(SteamLoginState loginState)
    {
        ...
        container.Add(loginState.Cookies!);
        var isolated = new IsolatedCookieContainer(container);
        var sendArgs = new WebApiClientSendArgs(SteamApiUrls.SteamStoreAddFundsUrl)
        {
            Method = HttpMethod.Get,
            JsonImplType = Serializable.JsonImplType.SystemTextJson,
            IsolatedCookie = isolated,
    ...
    public async Task<ApiRspImpl<InventoryTradeHistoryRenderPageResponse>> GetInventoryTradeHistory(SteamLoginState loginState, int[]? appFilter = null, InventoryTradeHistoryRenderPageResponse.InventoryTradeHistoryCursor? cursor = null)
    {
        ...
        var isolated = new IsolatedCookieContainer(container);
        var sendArgs = new WebApiClientSendArgs(urlBuilder.ToString())
        {
            Method = HttpMethod.Get,
            JsonImplType = Serializable.JsonImplType.SystemTextJson,
            IsolatedCookie = isolated
    ...
    public async Task<ApiRspImpl<string?>> GetApiKey(SteamLoginState loginState)
    {
        ...
        container.Add(loginState.Cookies!);
        var isolated = new IsolatedCookieContainer(container);
        var sendArgs = new WebApiClientSendArgs(url)
        {
            Method = HttpMethod.Get,
            JsonImplType = Serializable.JsonImplType.SystemTextJson,
            IsolatedCookie = isolated,
        ...
        var stream = await WaitAndRetryAsync().ExecuteAsync(async () =>
        {
            return await SendAsync<Stream>(sendArgs);
        });
        isolated.Dispose();

        return ApiRspHelper.Ok(await ParseApiKeyFromHttpContent(stream));
    }
    ...
    public async Task<ApiRspImpl<IEnumerable<SendGiftHistoryItem>>> GetSendGiftHistories(SteamLoginState loginState)
    {
        ...
        container.Add(loginState.Cookies!);
        var isolated = new IsolatedCookieContainer(container);
        var sendArgs = new WebApiClientSendArgs("https://steamcommunity.com/gifts/0/history/")
        {
            Method = HttpMethod.Get,
            JsonImplType = Serializable.JsonImplType.SystemTextJson,
            IsolatedCookie = isolated,
    ...
    private async Task<string?> ParseApiKeyFromHttpContent(Stream? respStream)
    {
        if (respStream == null)
            return string.Empty;
